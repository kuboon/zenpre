 ...
 * - 「スライドを作成」で `POST /api/slides`。返ってきた `slide_key` は
 *   localStorage に退避し、閲覧 URL とトーク作成ボタンを提示する。
 */
  ...
  createBtn?.addEventListener("click", async () => {
    ...
    try {
      ...
      if (result) {
        ...
        addLink("スライドを開く", slide.preview_url);
